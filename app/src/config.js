...
module.exports = {
    ...
    ngrok: {
        ...
        */
        enabled: false,
        authToken: '2rw2EVl1PJkSk77us7PZA1oxnbBk_KRXA1m2my1VM6TypQYF3',
    },
    azure: {
        /* 
        Azure Storage
            1. Needed for uploading screenshots to Azure Blob Storage
            2. Pay attention to the env and container name, make sure you're uploading to the correct environment (UAT to UAT, LIVE to LIVE)
        */
